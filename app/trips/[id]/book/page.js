    ...
    return (
      <main className="min-h-screen bg-stone-50 flex items-center justify-center p-4">
        <div className="bg-white max-w-lg w-full p-12 rounded-[2rem] shadow-2xl text-center border border-stone-100">
          ...
          <Link
            href="/trips"
            className="bg-amber-700 text-white px-10 py-4 rounded-xl font-bold hover:bg-amber-800 transition-all inline-block"
          >
            Back to Trips
          </Link>
        </div>
      ...
      <main className="min-h-screen bg-stone-50 flex items-center justify-center p-4">
        <div className="bg-white max-w-lg w-full p-12 rounded-[2rem] shadow-2xl text-center border border-stone-100">
          ...
          {isLoggedIn && (
            <Link
              href="/profile"
              className="bg-amber-700 text-white px-10 py-4 rounded-xl font-bold hover:bg-amber-800 transition-all block text-center shadow-lg"
            >
              View My Bookings
            </Link>
          )}
    ...
    <main className="bg-stone-50 min-h-screen">
      ...
      <div className="pt-32 pb-24 px-4 max-w-4xl mx-auto">
        <Link
          ...
          className="flex items-center text-stone-500 hover:text-amber-700 font-bold mb-8 transition-colors group"
        >
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl border border-stone-100 overflow-hidden grid grid-cols-1 md:grid-cols-5">
          <div className="md:col-span-2 bg-stone-900 p-10 text-white flex flex-col justify-between">
            <div>
              <h2 className="text-xs font-bold text-amber-400 uppercase tracking-widest mb-4">You're booking</h2>
          ...
          <form onSubmit={handleSubmit} className="md:col-span-3 p-10 space-y-8">
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full px-5 py-4 rounded-xl border border-stone-200 outline-none focus:ring-2 focus:ring-amber-500 font-medium"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    max="10"
                    required
                    className="w-full px-5 py-4 rounded-xl border border-stone-200 outline-none focus:ring-2 focus:ring-amber-500 font-black text-xl text-amber-700"
            ...
            <div className="pt-6 border-t border-stone-100 flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="bg-amber-700 text-white px-10 py-4 rounded-xl font-bold shadow-xl hover:bg-amber-800 transition-all flex items-center disabled:opacity-50"
              >
